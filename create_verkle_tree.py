...
with open('2016_US_County_Level_Presidential_Results.csv', 'r',encoding="ascii") as csvfile:
    ...
    for county in countyreader:
        ...
        dir =  "data/" + state_char_0 + "_" + county[state_abbr] + "_" \
               +  county_char_0 + "_" + county[county_name].replace(" ", "_")
        #if not os.path.exists(dir):
        #    os.makedirs(dir)

        path = dir + "_" + county[combined_fips]
